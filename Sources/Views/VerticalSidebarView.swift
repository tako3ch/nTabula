...
struct SidebarTabRow: View {
    ...
    var body: some View {
        HStack(spacing: 6) {
            Image(systemName: currentTab.isPinned ? "pin.fill" : "doc.text")
                .font(.system(size: 11))
            ...
            ZStack {
                Circle()
                    ...
                    .opacity(currentTab.isDirty && !isHovering ? 1 : 0)
        ...
        .onDrop(of: [.plainText], delegate: TabMoveDropDelegate(tab: tab, appState: appState))
    }
}
